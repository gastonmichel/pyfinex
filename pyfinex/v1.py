...
class V1(API):
    ...
    def ticker(self, **params):
        ...
        """
        endpoint = 'pubticker/' + params.pop('symbol')
    ...
    def stats(self, **params):
        ...
        """
        endpoint = 'stats/' + params.pop('symbol')
        return self.request(endpoint, method='GET', auth=False, params=params)
    ...
    def fundingbook(self, **params):
        ...
        """
        endpoint = 'lendbook/' + params.pop('currency')
        return self.request(endpoint, method='GET', auth=False, params=params)
    ...
    def orderbook(self, **params):
        ...
        """
        endpoint = 'book/' + params.pop('symbol')
        return self.request(endpoint, method='GET', auth=False, params=params)
    ...
    def trades(self, **params):
        ...
        """
        endpoint = 'trades/' + params.pop('symbol')
        return self.request(endpoint, method='GET', auth=False, params=params)
    ...
    def lends(self, **params):
        ...
        """
        endpoint = 'lends/' + params.pop('currency')
        return self.request(endpoint, method='GET', auth=False, params=params)
